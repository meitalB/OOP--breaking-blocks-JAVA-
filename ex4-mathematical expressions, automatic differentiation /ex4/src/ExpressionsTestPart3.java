...
public class ExpressionsTestPart3 {
    ...
    public static int main3() throws Exception
    {
        ...
        {
            System.out.println("Caught StackOverflowError -62");
        }
        ...
        try 
        {
            ...
            e = new Mult(new Minus(new Mult("x" , 2) , new Plus(new Mult("x" , 2) , new Mult("y" , 3))) ,new Plus(new Div(new Neg(9) , new Neg(9)) , new Mult(new Div(new Neg(9) , new Neg(9)) , new Neg(-1))) );
            e = e.assign("x", new Num(2));
        ...
        try
        {
            ...
            // ((1.0 + -(-9.0)) * -(-(-(-(-(-(-(-(-(-(-(-(-1.0))))))))))))) = -10.0
            e = new Mult(new Plus("x" , new Neg(-9)) ,new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(new Neg(-1)))))))))))) );
