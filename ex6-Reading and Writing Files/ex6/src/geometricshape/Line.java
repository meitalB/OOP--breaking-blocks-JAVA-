...
/**
 * geometricshape.Line. The program define geometricshape.Line.
 */
public class Line {
    private Point start;
    private Point end;
    ...
    public Point intersectionWith(Line other) {
        ...
        det = line1A * otherB - otherA * line1B;
                if (det == 0) {
                    ...
                    // check the limit of the x of intersection point.
                    ...
                    // check the limit of the y of intersection point.
                    ...
                    // check if the lines are in the boundaries.
    ...
    public Point closestIntersectionToStartOfLine(Rectangle rect) {
        ...
        // getting the intersection points in rectangle.
        listOfPoints = rect.intersectionPoints(this);
        if (listOfPoints.size() != 0) {
            for (int i = 0; i < listOfPoints.size(); i++) {
                // check the closet point to the start line.
