...
public class GameLevel implements Animation {
    ...
    public GameLevel(LevelInformation currentLevel, AnimationRunner animationRunner,
        ...
        this.blockList = this.level.blocks();
        this.ballList = new LinkedList<Ball>();
        this.paddleRect = new Rectangle(BOARD_WIDE / 2, BOARD_LENGHT - BLOCK_WIDTH + BLOCK_LEN,
    ...
    public void createBallsOnTopOfPaddle() {
        ...
        // adding the paddle.
        Rectangle newPaddleRect = new Rectangle((BOARD_WIDE / 2 - this.level.paddleWidth() / 2),
                BOARD_LENGHT - BLOCK_WIDTH + BLOCK_LEN,
                this.level.paddleWidth(),
                BLOCK_LEN);
        paddle = new Paddle(keyboard, newPaddleRect, this.level.paddleSpeed());
        paddle.addToGame(this);
    }
    /**
