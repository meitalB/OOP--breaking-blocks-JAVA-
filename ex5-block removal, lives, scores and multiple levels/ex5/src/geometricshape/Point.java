...
/**
 * class geometricshape.Point - the class define point with x, y values and functions on point.
 */
 public class Point {
     private double x;
     private double y;
    ...
    /**
     * the function set x value of the point.
     * @param numX - x point value.
     */
    public void setX(double numX) {
        this.x = numX;
     }
    /**
     * the function set y value of the point.
     * @param numY - y point value.
     */
